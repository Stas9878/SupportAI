...
def upgrade() -> None:
    ...
    op.create_index('ix_checkpoints_thread_checkpoint', 'checkpoints', ['thread_id', 'checkpoint_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_checkpoints_thread_checkpoint', table_name='checkpoints')
